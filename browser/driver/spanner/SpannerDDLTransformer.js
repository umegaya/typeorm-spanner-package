...
export { SpannerDDLTransformer };
;
export function MakeDebug(t) {
    return new Proxy(t, {
        get: function (target, prop, receiver) {
            ...
            if (typeof (origProp) === 'function') {
                return function () {
                    ...
                    console.log('-------------------------------------------');
                    console.log.apply(console, tslib_1.__spread([prop], args));
                    return origProp.call.apply(origProp, tslib_1.__spread([receiver], args));
                };
            }
            else {
                return origProp;
