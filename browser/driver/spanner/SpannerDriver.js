...
export var SpannerColumnUpdateWithCurrentTimestamp = "CURRENT_TIMESTAMP(6)";
export var SpannerColumnUpdateWithCommitTimestamp = "spanner.commit_timestamp()";
/**
...
var SpannerDriver = /** @class */ (function () {
    ...
    SpannerDriver.prototype.decodeDefaultValueGenerator = function (value) {
        if (value === SpannerColumnUpdateWithCommitTimestamp) {
            return function () { return SpannerColumnUpdateWithCommitTimestamp; };
        }
