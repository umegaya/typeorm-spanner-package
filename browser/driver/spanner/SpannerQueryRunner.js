...
var SpannerQueryRunner = /** @class */ (function (_super) {
    ...
    SpannerQueryRunner.prototype.handleAdministrativeQuery = function (type, m) {
        var _this = this;
        return this.connect().then(function (conn) { return __awaiter(_this, void 0, void 0, function () {
            var _a, p, name_1, p, name_2, name_3, sqls, ddl, extendSchames, tableName, table, columnName, column;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (type == "CREATE") {
                            ...
                            if (p[0] == "DATABASE") {
                                ...
                                return [2 /*return*/, this.driver.createDatabase(name_1)];
                            }
                        }
                        else if (type == "DROP") {
                            p = m[2].split(/\s/);
                            if (p[0] == "DATABASE") {
                                name_2 = this.unescapeName(p[1]);
                                if (p[1] == "IF") {
                                    if (p[2] != "EXISTS") {
                                        return [2 /*return*/, Promise.reject(new Error("invalid query " + m[0]))];
                                    }
                                ...
                                return [2 /*return*/, this.driver.dropDatabase(name_2)];
                            }
                            else if (p[0] == "TABLE") {
                                name_3 = this.unescapeName(p[1]);
                                return [2 /*return*/, this.driver.dropTable(name_3)];
                            }
                        }
