...
import { SpannerExtendedColumnPropsFromTableColumn } from "./SpannerRawTypes";
...
var SpannerQueryRunner = /** @class */ (function (_super) {
    __extends(SpannerQueryRunner, _super);
    // -------------------------------------------------------------------------
    // Constructor
    // -------------------------------------------------------------------------
    ...
    SpannerQueryRunner.prototype.startTransaction = function (isolationLevel) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.connect().then(function (db) { return __awaiter(_this, void 0, void 0, function () {
                        var _a;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                case 0:
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                return [2 /*return*/, new Promise(function (res, rej) {
                        _this.connect().then(function (db) { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                this.databaseConnection.runTransaction({
                                    ...
                                    //readOnly: true,
                                    strong: !!isolationLevel
                                }, function (err, tx) { return __awaiter(_this, void 0, void 0, function () {
                                    var r;
                                    var _this = this;
                                    return __generator(this, function (_a) {
                                        switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        _a = __read(parameters, 2), params = _a[0], types = _a[1];
    ...
    SpannerQueryRunner.prototype.hasDatabase = function (database) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                return [2 /*return*/, this.connect().then(function () { return __awaiter(_this, void 0, void 0, function () {
                        var dbs;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.createTable(new Table({
                                name: tableName,
                                columns: [
                                    {
                                        name: "table",
                    ...
                    case 4:
                        ...
                        schemas = {};
                        try {
                            for (rawObjects_1 = __values(rawObjects), rawObjects_1_1 = rawObjects_1.next(); !rawObjects_1_1.done; rawObjects_1_1 = rawObjects_1.next()) {
                                ...
                                tableSchemas[column] = this.createExtendSchemaObject(table, rawObject["type"], rawObject["value"]);
                            }
                        }
                                            ...
                                            try {
                                                for (_c = __values(t.columns), _d = _c.next(); !_d.done; _d = _c.next()) {
                                                    ...
                                                    if (add.length > 0) {
                                                        ...
                                                        try {
                                                            for (add_1 = __values(add), add_1_1 = add_1.next(); !add_1_1.done; add_1_1 = add_1.next()) {
                                                                a = add_1_1.value;
    ...
    SpannerQueryRunner.prototype.fillAutoGeneratedValues = function (table, columns, valuesSet) {
        var e_4, _a, e_5, _b;
        if (!valuesSet) {
            return valuesSet;
        }
        ...
        try {
            for (var valuesSet_1 = __values(valuesSet), valuesSet_1_1 = valuesSet_1.next(); !valuesSet_1_1.done; valuesSet_1_1 = valuesSet_1.next()) {
                var values = valuesSet_1_1.value;
                try {
                    for (var columns_1 = __values(columns), columns_1_1 = columns_1.next(); !columns_1_1.done; columns_1_1 = columns_1.next()) {
                        var column = columns_1_1.value;
                        if (values[column.databaseName] === undefined) {
                            var value = this.driver.autoGenerateValue(table.name, column.databaseName);
                            if (value !== undefined) {
                ...
                switch (_g.label) {
                    case 0:
                        ...
                        if (expressionMap.parameters.qb_ids) {
                            ...
                            keys_2 = [];
                            try {
                                for (_b = __values(Object.keys(expressionMap.nativeParameters)), _c = _b.next(); !_c.done; _c = _b.next()) {
                                    k = _c.value;
                        ...
                        _d = __read(qb.getQueryAndParameters(), 2), query = _d[0], parameters = _d[1];
                        _e = __read(parameters, 2), params = _e[0], types = _e[1];
                        if (m = query.match(/IN\(([^)]+)\)/)) {
                    ...
                    case 1:
                        _f = __read.apply(void 0, [_g.sent(), 2]), results = _f[0], err = _f[1];
                        if (err) {
    ...
    SpannerQueryRunner.prototype.request = function (table, method) {
        ...
        if (this.driver.connection.options.logging) {
            this.driver.connection.logger.logQuery(method + " " + Table.name + " " + (this.isTransactionActive ? "tx" : "normal"), args[0]);
        }
        if (this.tx) {
            return (_a = this.tx)[method].apply(_a, __spread([table.name], args));
        }
        else {
            return (_b = this.databaseConnection.table(table.name))[method].apply(_b, __spread(args));
        }
    };
    /**
     * Handle select query
    ...
    SpannerQueryRunner.prototype.select = function (qb) {
        var _a = __read(qb.getQueryAndParameters(), 2), query = _a[0], parameters = _a[1];
    ...
    SpannerQueryRunner.prototype.insert = function (qb) {
        var _this = this;
        return new Promise(function (ok, fail) { return __awaiter(_this, void 0, void 0, function () {
            var table, columnMetadatas, vss, e_7;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        columnMetadatas = qb.getInsertedColumns();
                        vss = this.fillAutoGeneratedValues(table, columnMetadatas, qb.expressionMap.valuesSet);
    ...
    SpannerQueryRunner.prototype.upsert = function (qb) {
        var _this = this;
        return new Promise(function (ok, fail) { return __awaiter(_this, void 0, void 0, function () {
            var e_10, _a, vs, table, value, rows, rows_2, rows_2_1, row, e_11;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 4, , 5]);
                    ...
                    case 2:
                        ...
                        // callback not provided see comment of insert
                        return [4 /*yield*/, this.request(table, 'upsert', rows)];
                    case 3:
                        // callback not provided see comment of insert
                        _b.sent();
                        ok(rows);
    ...
    SpannerQueryRunner.prototype.handleAdministrativeQuery = function (type, m) {
        ...
        return this.connect().then(function (conn) {
            if (type == "CREATE") {
                var p = m[2].split(/\s/);
                if (p[0] == "DATABASE") {
                    var name_1 = _this.unescapeName(p[1]);
                    if (p[1] == "IF") {
                        if (p[2] != "NOT") {
                    ...
                    return _this.driver.createDatabase(name_1);
                }
            }
            else if (type == "DROP") {
                var p = m[2].split(/\s/);
                if (p[0] == "DATABASE") {
                    var name_2 = _this.unescapeName(p[1]);
                    if (p[1] == "IF") {
                        if (p[2] != "EXISTS") {
                            return Promise.reject(new Error("invalid query " + m[0]));
                        }
                    ...
                    return _this.driver.dropDatabase(name_2);
                }
                else if (p[0] == "TABLE") {
                    var name_3 = _this.unescapeName(p[1]);
                    return _this.driver.dropTable(name_3);
                }
            }
            //others all updateSchema
            return conn.updateSchema(m[0]).then(function (data) {
