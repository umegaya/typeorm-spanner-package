...
export declare class SpannerQueryRunner extends BaseQueryRunner implements QueryRunner {
    ...
    protected verifyAndFillAutoGeneratedValues(table: Table, valuesSet?: ObjectLiteral | ObjectLiteral[]): undefined | ObjectLiteral | ObjectLiteral[];
    protected verifyValues(table: Table, valuesSet?: ObjectLiteral | ObjectLiteral[]): undefined | ObjectLiteral | ObjectLiteral[];
    /**
     * helper for createAndLoadSchemaTable.
