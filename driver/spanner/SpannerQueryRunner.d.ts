...
import { SpannerExtendSchemas, SpannerExtendColumnSchema, SpannerExtendedColumnProps, SpannerExtendedTableProps } from "./SpannerRawTypes";
...
export declare class SpannerQueryRunner extends BaseQueryRunner implements QueryRunner {
    ...
    protected fillAutoGeneratedValues(table: Table, columns: ColumnMetadata[], valuesSet?: ObjectLiteral | ObjectLiteral[]): undefined | ObjectLiteral | ObjectLiteral[];
    /**
     * helper for createAndLoadSchemaTable.
