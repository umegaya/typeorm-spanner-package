...
var SpannerDriver_1 = require("../driver/spanner/SpannerDriver");
...
var InsertQueryBuilder = /** @class */ (function (_super) {
    ...
    InsertQueryBuilder.prototype.execute = function () {
        return __awaiter(this, void 0, void 0, function () {
            var queryRunner, transactionStartedByUs, valueSets, broadcastResult_1, returningResultsEntityUpdator, insertResult, _a, broadcastResult_2, error_1, rollbackError_1;
            var _this = this;
    ...
    InsertQueryBuilder.prototype.getInsertedColumns = function () {
        ...
        return this.expressionMap.mainAlias.metadata.columns.filter(function (column) {
            ...
            if (column.isGenerated && column.generationStrategy === "increment" &&
                ...
                !(_this.connection.driver instanceof SpannerDriver_1.SpannerDriver))
                return false;
            return true;
        });
    };
