...
var BaseQueryRunner = /** @class */ (function () {
    ...
    BaseQueryRunner.prototype.queryByBuilder = function (qb) {
        var _a = tslib_1.__read(qb.getQueryAndParameters(), 2), sql = _a[0], parameters = _a[1];
    ...
    BaseQueryRunner.prototype.runInTransaction = function (runInTransaction, isolationLevel) {
        return tslib_1.__awaiter(this, void 0, void 0, function () {
            var queryRunner, ret;
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [3 /*break*/, 4];
                    case 2: return [4 /*yield*/, queryRunner.startTransaction()];
                    case 3:
                        _a.sent();
                        _a.label = 4;
